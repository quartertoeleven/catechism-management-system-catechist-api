...
def get_specific_grade_schedule(schedule_id):
    ...
    return OperationResult(success=True, message="Schedule found", data=schedule.to_dict())
...
def create_or_update_grade_schedule(grade_code, schedule_dict):
    ...
    if schedule_dict.get("general_schedule_id") is not None:
        general_schedule = GeneralSchedule.find_by_id(schedule_dict.get("general_schedule_id"))
        ...
        if current_grade_schedule.mass_content is None or not current_grade_schedule.mass_content.strip():
        ...
        if current_grade_schedule.is_mass_attendance_check is None:
            current_grade_schedule.is_mass_attendance_check = general_schedule.is_mass_attendance_check
        if current_grade_schedule.lesson_content is None or not current_grade_schedule.lesson_content.strip():
        ...
        if current_grade_schedule.is_lesson_attendance_check is None:
            current_grade_schedule.is_lesson_attendance_check = general_schedule.is_lesson_attendance_check
