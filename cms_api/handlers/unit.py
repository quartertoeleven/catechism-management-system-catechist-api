...
def get_unit_list_for_a_catechist(catechist: Catechist, study_year_code: str):
    ...
    catechist_current_unit = catechist.units.filter(Unit.grade_id == study_year.grade_id).first()
    ...
    for unit in current_grade_units:
        ...
        unit_dict["my_unit"] = True if unit.code == catechist_current_unit.code else False
