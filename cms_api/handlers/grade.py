...
def get_grade_schedules(grade_code):
    ...
    return OperationResult(success=True, message="Grade schedule found", data=all_schedules_as_dict)
...
def get_grade_units(grade_code):
    ...
    return OperationResult(success=True, message="Grade units found", data=all_units_as_dict)